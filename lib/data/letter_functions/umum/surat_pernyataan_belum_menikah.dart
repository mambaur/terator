...
String suratPernyataanBelumMenikah(
  ...
  String html = """
    <p style="text-align: center;">
      <b>SURAT PERNYATAAN BELUM MENIKAH</b>
    </p>
    <p><br></p>
    ...
    <p>
      <table border="0" style="width:100%">
          ...
          <tr>
						<td style="white-space: nowrap">Warga Negara</td>
						<td>:&nbsp</td>
          ...
          <tr>
						<td style="white-space: nowrap">Alamat/Tempat Tinggal</td>
						<td>:&nbsp</td>
    ...
    <p style="text-align: justify; ">
      Menyatakan dengan sesungguhnya bahwa saya belum pernah menikah dengan siapapun baik secara Adat, Hukum Agama, maupun Hukum Negara.
    </p>
    <p style="text-align: justify; ">
